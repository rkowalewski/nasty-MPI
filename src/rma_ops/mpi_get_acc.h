...
#ifndef _MPI_GET_ACC_H
#define _MPI_GET_ACC_H
...
typedef struct S_MpiGetAcc T_MpiGetAcc;

typedef struct S_MpiGetAcc_CtorParams {
   T_MpiRmaOp_CtorParams super_params;

   //-- add your ctor params here
} T_MpiGetAcc_CtorParams;
 ...
 */
static inline T_MpiRmaOp *mpi_get_acc__mpi_rma_op__get(T_MpiGetAcc *me)
{
